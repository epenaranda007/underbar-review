(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var init = accumulator === undefined;
    ...
    _.each(collection, function(value, key, collection) {
      if ( init ) {
        ...
        var temp = iterator(accumulator, value);
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(wasTrue, item) {
      ...
      return wasTrue && Boolean(iterator(item));
  ...
  _.some = function(collection, iterator) {
    ...
    iterator = iterator || _.identity;
    var temp = _.every(collection, function(value) {
  ...
  _.delay = function(func, wait) {
    var arg = Array.from(arguments).slice(2, arguments.length);
    setTimeout(function() {
      func.apply(this, arg);
    }, wait);
  };
